      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div className="brutal-card bg-background p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[9px] font-black uppercase tracking-widest text-foreground/50">Articles</span>
        ...
        <div className="brutal-card bg-background p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[9px] font-black uppercase tracking-widest text-foreground/50">Authors</span>
        ...
        <div className="brutal-card bg-background p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[9px] font-black uppercase tracking-widest text-foreground/50">Active Jobs</span>
        ...
        <div className={`brutal-card p-6 ${(failedJobs ?? 0) > 0 ? 'bg-red-50 border-red-400' : 'bg-background'}`}>
          <div className="flex items-center justify-between mb-3">
            <span className={`text-[9px] font-black uppercase tracking-widest ${(failedJobs ?? 0) > 0 ? 'text-red-500' : 'text-foreground/50'}`}>Failed Jobs</span>
            <AlertTriangle size={16} className={(failedJobs ?? 0) > 0 ? 'text-red-500' : 'text-foreground/30'} />
          </div>
