          ...
          <tbody>
            {categories.length === 0 ? (
              ...
              <tr key={cat.id} className="border-t-[3px] border-foreground hover:bg-muted transition-colors">
                ...
                <td className="p-3.5 hidden md:table-cell text-[10px] font-black tracking-widest text-foreground/50">/{cat.slug}</td>
                <td className="p-3.5 text-xs font-medium text-foreground/60 max-w-[200px] truncate">{cat.description || '—'}</td>
