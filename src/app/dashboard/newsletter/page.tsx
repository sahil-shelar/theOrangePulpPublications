    ...
    <div className="p-6 md:p-8 max-w-6xl mx-auto space-y-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        ...
        <div className="brutal-card bg-primary p-6">
          <div className="text-[9px] font-black uppercase tracking-widest mb-2">Campaigns</div>
            ...
            <tbody>
              {campaigns && campaigns.length > 0 ? campaigns.map((campaign: any) => (
                <tr key={campaign.id} className="border-t-[3px] border-foreground hover:bg-muted transition-colors">
                  ...
                  <td className="p-3.5">
                    <span className={`text-[9px] font-black uppercase tracking-widest px-2 py-1 border-[2px] border-foreground ${campaign.status === 'sent' ? 'bg-primary' : 'bg-secondary'}`}>
                      {campaign.status}
                    </span>
                  </td>
