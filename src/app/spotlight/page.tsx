  ...
  return (
    <div className="w-full bg-background min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12">
        ...
        {spotlight.length === 0 ? (
          <div className="py-24 text-center font-bold uppercase tracking-widest text-muted-foreground border-[3px] border-dashed border-foreground/20 bg-accent">
              ...
              <div className="mb-12">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="bg-accent on-pastel p-8 md:p-12 flex flex-col justify-center gap-4">
